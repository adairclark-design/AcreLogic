...
export const MEGA_CATEGORIES = [
    ...
    // ── Roots & Tubers ────────────────────────────────────────────────────────
    {
        ...
        subcategories: [
            ...
            { label: 'Potatoes',             filter: c => c.id.includes('potato') && !c.id.includes('sweet_potato') && !c.id.includes('potato_onion') },
            { label: 'Sweet Potato',         filter: c => c.id.includes('sweet_potato') },
            { label: 'Turnips & Radishes',   filter: c => c.category !== 'Cover Crop' && (c.id.includes('radish') || c.id.includes('turnip') || c.id.includes('daikon') || c.id.includes('rutabaga') || c.id.includes('swede')) },
    ...
    // ── Tomatoes ─────────────────────────────────────────────────────────────
    {
        ...
        subcategories: [
            ...
            { label: 'Heirlooms and Other Tomatoes', filter: c => c.category === 'Nightshade' && c.id.includes('tomato') && !c.id.includes('cherry') && !c.id.includes('grape') && !c.id.includes('pear') && !c.id.includes('juliet') && !c.id.includes('roma') && !c.id.includes('san_marzano') && !c.id.includes('paste') && !c.id.includes('tomatillo') && !c.id.includes('ground') && !c.id.includes('husk') },
        ],
    ...
    // ── Cover Crops ───────────────────────────────────────────────────────────
    {
        ...
        subcategories: [
            ...
            { label: 'Turnips & Radish',     filter: c => c.category === 'Cover Crop' && (c.id.includes('radish') || c.id.includes('turnip') || c.id.includes('daikon')) },
            { label: 'Nitrogen Fixers',      filter: c => c.category === 'Cover Crop' && (c.subcategory === 'Nitrogen Fixers' || c.id.includes('clover') || c.id.includes('vetch') || c.id.includes('pea') || c.id.includes('hemp') || c.id.includes('cowpea')) },
            { label: 'Grasses & Grains',     filter: c => c.category === 'Cover Crop' && (c.subcategory === 'Grasses' || c.id.includes('rye') || c.id.includes('ryegrass') || c.id.includes('oat') || c.id.includes('wheat')) && !c.id.includes('radish') && !c.id.includes('turnip') },
            { label: 'Brassica Covers',      filter: c => c.category === 'Cover Crop' && (c.id.includes('mustard') || c.id.includes('rape') || c.id.includes('tyfon') || c.id.includes('phacelia')) },
        ],
