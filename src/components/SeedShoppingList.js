...
const CATEGORY_SPECS = {
    ...
    'Tuber':      { seedsPerPacket:   1, price: 4.99, unit: 'starts', isSpecial: true },  // potatoes, sweet potatoes
    ...
    'Fruit':      { seedsPerPacket:   1, price: 6.99, unit: 'plants', isSpecial: true }, // strawberries, cane fruit
...
function specsFor(crop) {
    return CATEGORY_SPECS[crop.category] ?? DEFAULT_SPECS;
}
        ...
        >
            ...
            <View style={styles.disclaimer}>
                <Text style={styles.disclaimerText}>
                    💡 Prices are retail averages based on Johnny's, Baker Creek, and High Mowing's standard packet sizes.
                    Your actual cost will vary. Germination buffer already factored into seed quantities.
                </Text>
            </View>
        </ScrollView>
    );
